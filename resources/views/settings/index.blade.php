                ...
                <div class="form-group">
                    <div class="tablet movedown">
                        ...
                        <div class="tablet__body">
                            ...
                            <br>
                            <input name="company" type="text" class="form-control company_name" value="{{$settings->company}}" {{!$settings->company ? '' : 'enabled'}} style="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    <div class="tablet movedown">
                        ...
                        <div class="tablet__body">
                            <p class="small">@lang('Your working hours')</p>
                            <br>
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    @lang('Start of of your working hours')
                        </span>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span class="help-block">
                                    @lang('End of your working hours')
                        </span>
                                </div>
                            </div>
                        </div>
