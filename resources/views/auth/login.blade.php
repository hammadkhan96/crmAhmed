    ...
    <div class="container" style="margin-top:45px;" >
        <div class="row">
            ...
            <div class="col-md-5 col-md-offset-4">
                ...
                <img src="https://3.imimg.com/data3/BH/PU/MY-8403536/lead-management-system-500x500.jpg" width="300px"
                                                     alt="" style="margin-top:1em; margin-bottom:1em; margin-left: 15%" class="logo-placment"></a>
                 <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
                            ...
                            <div class="inner-addon right-addon">
                                <div class="col-md-12 input-group-lg">
                                    ...
                                    <input type="email"  class="form-control" style="border-radius: 4px; box-shadow:0px 2px 4px rgba(0,0,0,0.18); padding-right:40px; " name="email" placeholder="E-mail address">
