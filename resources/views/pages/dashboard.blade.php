                ...
                var currentDate = fullDate.getDate() + "/" + twoDigitMonth + "/" + fullDate.getFullYear();
                    ...
                    var table = $('#follow-ups-table').DataTable({
                        ...
                        "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                            console.log(aData["deadline"],currentDate);
                            if(aData["deadline"] === currentDate) {

                                $('td', nRow).css('background-color', 'lightgoldenrodyellow');
                            }
                        },
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-white">
                <div class="inner">
                    ...
                    <p>{{ __('Total Follow-Ups') }}</p>
                </div>
                <div class="icon">
                    <i class="ion ion-stats-bars"></i>
                </div>
                <a href="{{route('leads.index')}}" class="small-box-footer">{{ __('All Follow-Ups') }} <i
                            class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
