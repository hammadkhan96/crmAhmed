...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('dashboard/notifications', 'PagesController@dashboardNotifications')->name('dashboard.notifications');
    Route::get('dashboard/follow-ups', 'PagesController@followUps')->name('dashboard.followups');
    Route::get('sample_data/view', 'PagesController@sampleDataView')->name('sample_view');
    Route::get('dashboard/sample-data', 'PagesController@sampleData')->name('dashboard.sampledata');
    Route::post('/sample_data/submit', 'PagesController@sampleSubmit')->name('sampledata.submit');
    ...
    Route::group(['prefix' => 'users'], function () {
        ...
        Route::post('/documents-users', 'UsersController@userDocuments')->name('users.documents');
    });
    ...
    */
    ...
    Route::get('clients/visit/create', 'ClientsController@clientVisitCreateIndex')->name('clients.visit.create');
    Route::post('clients/visit/submit', 'ClientsController@clientVisitCreateSubmit')->name('clients.visit.submit');
    Route::get('client_visit', 'ClientsController@clientVisit')->name('client_visit');
    Route::get('client_visit/list', 'ClientsController@clientVisitList')->name('client_visit.list');
    ...
    Route::group(['prefix' => 'stockIn'], function () {
        Route::get('/', 'StocksController@index')->name('stockIn.index');
        Route::get('list', 'StocksController@stockInList')->name('stockin.list');
        Route::DELETE('/delete/{id}', 'StocksController@deletestock')->name('deletestock');
        Route::get('/creator/{external_id?}', 'StocksController@stockinCreator')->name('stockIn.creator');
        Route::post('submit/', 'StocksController@stockInSubmit')->name('stockIn.submit');
    ...
    Route::group(['prefix' => 'stockout'], function () {
        Route::get('/', 'StockoutController@index')->name('stockout.index');
        Route::get('list', 'StockoutController@stockInList')->name('stockout.list');
        Route::post('submit', 'StockoutController@stockOutSubmit')->name('stockout.submit');
    ...
    Route::group(['prefix' => 'projects'], function () {
        ...
        Route::get('download','ProjectsController@download');
    });
    ...
    Route::group(['prefix' => 'notifications'], function () {
        ...
        Route::get('/{id}', 'NotificationsController@markRead')->name('read');
    });
