...
class User extends Authenticatable
{
    ...
    {
        //dd($this->name,$this->relations['department'][0]->name, $this->department()->toSql(), $this->department()->getBindings());
    ...
    {
        //asset("storage/$projects->pi");
        //$image_path = $this->image_path ? Storage::url('profile/'.$this->image_path) : '/images/default_avatar.jpg';
        $image_path = $this->image_path ? asset("storage/profile/$this->image_path") : '/images/default_avatar.jpg';
        return $image_path;
    }
